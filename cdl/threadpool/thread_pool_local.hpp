...
// Class Implementation: cdl::threadpool::thread_pool_local
//
// An extension of the simple thread pool implementation
// (cdl::threadpool::simple_thread_pool) that adds 
// thread-local work queues to reduce contention.
...
namespace cdl::threadpool
{
	...
	{
		cdl::concurrent::queue<function_wrapper> pool_work_queue_;
